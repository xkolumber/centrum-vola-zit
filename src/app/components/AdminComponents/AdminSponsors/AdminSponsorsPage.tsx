...
const AdminSponsorsPage = () => {
  ...
  const handleDeleteAlbum = async () => {
    try {
      ...
      const response = await AdminDeleteSponsor(idAlbum);
  ...
  return (
    <div className=" min-h-screen">
      <Link className=" btn btn--primary" href="/admin/sponzori/novy-sponzor">
        Pridať sponzora
      </Link>

      <Toaster />

      <h4 className="mt-8">Všetci sponzori</h4>
