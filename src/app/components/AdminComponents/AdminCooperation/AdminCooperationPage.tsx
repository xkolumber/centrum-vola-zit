...
const AdminCooperationPage = () => {
  ...
  const handleDeleteAlbum = async () => {
    try {
      ...
      const response = await AdminDeleteCooperationId(idAlbum);
  ...
  return (
    <div className=" min-h-screen">
      <Link
        ...
        href="/admin/spolupracujeme/novy-partner"
      >
        Pridať partnera
      </Link>
      ...
      <h4 className="mt-8">Všetci partneri</h4>
          ...
          >
            ...
            <div className="flex flex-row items-center gap-6">
              <Link
                ...
                href={`/admin/spolupracujeme/${object.id}`}
              >
                <IconPen />
              </Link>
